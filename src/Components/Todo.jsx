  ...
  return (
    ...
    >
      <Grid container className="container-main-con" sx={{ alignItems: 'center', marginTop: '12px' }}>
        <Grid item>
          <Typography variant="h4" className="taskName" sx={{ display: 'flex', alignItems: 'center', color: '#ffffff', fontFamily: 'Inter', marginLeft: '42px',  fontSize : "18px" , marginBottom:'8px' }}>
            <Box component="span" className="dot1" sx={{ color: '#5030E5', marginRight: '6px' }}>
              &bull;
            </Box>
            To Do
            <Box
        ...
        <Grid item xs={12}>
          <Divider sx={{ width: '100%', padding: '1px', backgroundColor: '#5030E5' }} />
